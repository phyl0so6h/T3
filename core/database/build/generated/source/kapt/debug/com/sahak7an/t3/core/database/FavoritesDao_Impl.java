...
public final class FavoritesDao_Impl implements FavoritesDao {
  ...
  public FavoritesDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfFavoriteEntity = new EntityInsertionAdapter<FavoriteEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `favorites` (`courseId`) VALUES (?)";
      }
    ...
    this.__deletionAdapterOfFavoriteEntity = new EntityDeletionOrUpdateAdapter<FavoriteEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "DELETE FROM `favorites` WHERE `courseId` = ?";
      }
  ...
  @Override
  public Object insert(final FavoriteEntity entity, final Continuation<? super Unit> arg1) {
  ...
  @Override
  public Object delete(final FavoriteEntity entity, final Continuation<? super Unit> arg1) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
      ...
      public List<FavoriteEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new FavoriteEntity(_tmpCourseId);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Flow<Boolean> observeIsFavorite(final int courseId) {
    final String _sql = "SELECT EXISTS(SELECT 1 FROM favorites WHERE courseId = ?)";
